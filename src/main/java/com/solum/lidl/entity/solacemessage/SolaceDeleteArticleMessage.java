...
import com.solum.lidl.entity.solacemessage.payload.article.DeleteArticleItems;
...
@NoArgsConstructor
@ToString
public class SolaceDeleteArticleMessage {

	    @JsonProperty("MetaData") 
	    private MetaData metaData;
	    @JsonProperty("Payload") 
	    private DeleteArticleItems payload;
