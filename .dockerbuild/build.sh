...
docker_push () {
  ...
  [ ! -z "${APP_VERSION}" ] && buildah push "${APP_REGISTRY_IMAGE}:${APP_VERSION}"
  [ ! -z "${APP_PATCH_VERSION}" ] && buildah push "${APP_REGISTRY_IMAGE}:${APP_PATCH_VERSION}"
  [ ! -z "${APP_MINOR_VERSION}" ] && buildah push "${APP_REGISTRY_IMAGE}:${APP_MINOR_VERSION}"
  [ ! -z "${APP_MAYOR_VERSION}" ] && buildah push "${APP_REGISTRY_IMAGE}:${APP_MAYOR_VERSION}"
